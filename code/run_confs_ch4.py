...
data = np.load("../../../datasets/cellcycle_dataset_ch4/cellCycle.npy")
labels = np.load("../../../datasets/cellcycle_dataset_ch4/labels.npy")
root_graphs = "../graphs/training_test/original_ch4/"
...
for model in list_models:
    ...
    for train_index, test_index in skfolds.split(data, labels):
        ...
        name_model = 'model_CNN_ch4_' + str(num_fold) + '_' + str(no_model)
        ...
        name_graph = 'model_CNN_ch4' + str(num_fold) + '_' + str(no_model) + '_' + 'val_and_loss'
        ...
        rootcm = "../graphs/cm/original_ch4/cm_"
