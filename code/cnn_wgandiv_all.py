...
list_models = [CNN_conf2.base_model(), CNN_conf3.base_model(), CNN_conf4.base_model()]
no_model = 1
for model in list_models:
    ...
    for train_index, test_index in skfolds.split(data, labels):
        ...
        name_model = 'model_CNN_with_wgandiv_' + str(num_fold) + '_' + str(no_model)
        ...
        name_graph = 'model_CNN_with_wgandiv_' + str(num_fold) + '_' + str(no_model) + '_' + 'val_and_loss'
