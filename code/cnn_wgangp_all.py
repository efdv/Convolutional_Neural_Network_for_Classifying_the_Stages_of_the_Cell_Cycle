# -*- coding: utf-8 -*-
"""
Created on Tue Oct 24 17:47:10 2023
...
root_graphs = "../graphs/training_test/"
...
for model in list_models:
    ...
    for train_index, test_index in skfolds.split(data, labels):
        ...
        name_model = 'model_CNN_with_wgangp_' + str(num_fold) + '_' + str(no_model)
        ...
        name_graph = 'model_CNN_with_wgangp_' + str(num_fold) + '_' + str(no_model) + '_' + 'val_and_loss'
